        ...
        <div className="flex-cont">
          <div className="background-image">
            <img
              src={
                backgroundBg
                  ? `https://metoyou-server.vercel.app/assets/${backgroundBg} `
                  : "https://metoyou-server.vercel.app/assets/facts.jpg"
              }
              alt="background"
            />
          </div>
        ...
        <div className="photos flex-cont">
          ...
          <div className="photos-cont">
            ...
            <div className="other-photos">
              ...
              <div className="other-photos-img">
                <img
                  src="https://metoyou-server.vercel.app/assets/profile-pic.png"
                  alt=""
                  className="other-photos-img"
                />
              </div>
              ...
              <div className="last-photo">
                <img
                  src="https://metoyou-server.vercel.app/assets/Facebook.png"
                  alt=""
                  className="other-photos-img"
                />
