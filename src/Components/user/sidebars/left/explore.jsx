      ...
      <div className="all-exp-images">
        <div className="upp-img-div">
          <div className="exp-images-cont col1">
            <img
              src="https://metoyou-server.vercel.app/assets/profile-2.jpg"
              alt=""
            />
          </div>
          ...
          <div className="exp-images-cont col2">
            <img
              src="https://metoyou-server.vercel.app/assets/profile-3.jpg"
              alt=""
            />
          </div>
          ...
          <div className="exp-images-cont right-image">
            <img
              src="https://metoyou-server.vercel.app/assets/moses-bliss.jpg"
              alt=""
            />
          </div>
          ...
          <div className="exp-images-cont col3">
            <img
              src="https://metoyou-server.vercel.app/assets/elon-musk.jpg"
              alt=""
            />
          </div>
        ...
        <div className="botm-exp-images">
          ...
          <div className="exp-images-cont col1">
            <img
              src="https://metoyou-server.vercel.app/assets/testimony.jpg"
              alt=""
            />
          </div>
          ...
          <div className="exp-images-cont col2">
            <img
              src="https://metoyou-server.vercel.app/assets/cutty.png"
              alt=""
            />
          </div>
          ...
          <div className="exp-images-cont col4">
            <img
              src="https://metoyou-server.vercel.app/assets/dev-harrison.jpg"
              alt=""
            />
          </div>
          ...
          <div className="exp-images-cont col5">
            <img
              src="https://metoyou-server.vercel.app/assets/cynthia.jpeg"
              alt=""
            />
          </div>
        </div>
